...
\subsection{Controller}
  Der Controller spielt eine sehr zentrale Rolle in pyPsy, da er die Schnittstelle zwischen GUI und den funktionalen Klassen bildet. Im Sinne des Design Patterns "`Model View Controller"' bedeutet dies, dass Klassen, die die GUI verwalten auf bspw. die Clock nur über den Controller zugreifen können. 
  \begin{figure}[ht]
    \begin{center}
